"""
Django settings for square_morning_40818 project.
...
ROOT_URLCONF = 'square_morning_40818.urls'
...
WSGI_APPLICATION = 'square_morning_40818.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "square_morning_40818 API",
    "DESCRIPTION": "API documentation for square_morning_40818 App",
    "VERSION": "v1",
}
